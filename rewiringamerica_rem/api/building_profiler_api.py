...
class BuildingProfilerApi:
    ...
    def get_home_profile(
        self,
        address: Annotated[str, Field(min_length=1, strict=True, description="The location of a home.")],
        ...
        :param address: The location of a home. (required)
        :type address: str
        ...
        _param = self._get_home_profile_serialize(
            address=address,
    ...
    @validate_call
    def get_home_profile_with_http_info(
        self,
        address: Annotated[str, Field(min_length=1, strict=True, description="The location of a home.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_home_profile_without_preload_content(
        self,
        address: Annotated[str, Field(min_length=1, strict=True, description="The location of a home.")],
        _request_timeout: Union[
            None,
    ...
    def _get_home_profile_serialize(
        self,
        address,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/building_profiler/home',
